<section class='videos'>
	...
	<div class='section_title_videos'>
		<div class='title_bg'>
			<h2>VIDEOS</h2>
		</div>
	</div>
		...
		<div class='owl-carousel' id='videos_owl'>
			...
			<div class="carousel_item">
				<div class='player_container'>
					<div class='video_player' id='player5'></div>
				</div>
				<div class='video_cover_container' data-index='4'>
					<div class='video_cover four'></div>
					<div class='player_ux_full'>
						<div class='play_icon_container'>
							<div class='play_icon'></div>
						</div>
						<div class='text_description_container'>
							<p>ZOMLINGS© SERIES 5 - TV COMMERCIAL</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="carousel_item">
				<div class='player_container'>
					<div class='video_player' id='player4'></div>
				</div>
				<div class='video_cover_container' data-index='3'>
					<div class='video_cover three'></div>
					<div class='player_ux_full'>
						<div class='play_icon_container'>
							<div class='play_icon'></div>
						</div>
						<div class='text_description_container'>
							<p>STAR MONSTERS© SERIES 2 - TV COMMERCIAL</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="carousel_item">
				...
				<div class='video_cover_container' data-index='2'>
					...
					<div class='player_ux_full'>
						...
						<div class='text_description_container'>
							<p>ZOMLINGS© SERIES 4 - TV COMMERCIAL</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="carousel_item">
				...
				<div class='video_cover_container' data-index='1'>
					...
					<div class='player_ux_full'>
						...
						<div class='text_description_container'>
							<p>STAR MONSTERS© SERIES 1 - TV COMMERCIAL</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="carousel_item">
				...
				<div class='video_cover_container' data-index='0'>
					...
					<div class='player_ux_full'>
						...
						<div class='text_description_container'>
							<p>ZOMLINGS© SERIES 3 - TV COMMERCIAL</p>
						</div>
					</div>
				</div>
			</div>
