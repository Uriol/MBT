			...
			<div class='form_container'>
						    ...
						    <!-- Country -->
						     ...
						     <select name="pais" size="1" class='select_country'>
				                <!-- <option value='' disabled selected>Spain</option> -->
					...
					<?php 
						...
						if ($action=="") { 
						    ...
						    if (!filter_var($email, FILTER_VALIDATE_EMAIL) && $email!="") {
						        ...
						        // echo "<h2 class='thanks'>Gracias!</h2></br><p class='thanks'>Tu mensaje ha sido enviado y nos pondremos en contacto próximamente.</p></br><p class='new_message'>Para enviar un nuevo mensaje, vuelve a rellenar <a class='form' href=\"\">el formulario</a></p>"; 
						        	echo "<script>
