...
$(function(){
	...
	// Scroll left
	$('.arrow_wrapper .arrow_container.left').on('click', function(){
		stop_all_players()
	...
	$('.arrow_wrapper .arrow_container.left').hide();
	...
	owl.on('changed.owl.carousel',function(e){
		...
		if ((current_page+1) == number_of_pages) {
			$('.arrow_wrapper .arrow_container.right').hide();
	    } else {
	    	$('.arrow_wrapper .arrow_container.right').show();
	    }
	    ...
	    if ( current_page == 0  ) {
	    	...
	    	$('.arrow_wrapper .arrow_container.left').show();
	    }
